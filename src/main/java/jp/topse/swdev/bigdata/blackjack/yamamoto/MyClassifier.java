...
public class MyClassifier {
	...
	public void applyModel(Classifier tree, Instances instances) throws Exception {
		...
		Attribute small = new Attribute("small", 0);
		Attribute large = new Attribute("large", 1);
		Attribute noa = new Attribute("noa", 2);
	...
	public Instances readCSV(String fileName, int classIndex) throws Exception {
		...
		String[] options = new String[] {"-N", (classIndex)+","+(classIndex+1)};
